...
class User(Base):
    ...
    default_lot_size = Column(Float, default=0.01)
    default_leverage = Column(Integer, default=100)
    confirmation_dialogs = Column(Boolean, default=True)
    one_click_trading = Column(Boolean, default=False)
    slippage_tolerance = Column(Float, default=0.5)
    
    # Legal & Compliance
    tax_residency = Column(String(100), nullable=True)
