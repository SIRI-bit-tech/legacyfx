// Selector fields for Assets Deposit modal
'use client';

export function AssetsDepositModalSelectors({
  assetSymbol,
  onChangeAsset,
  assetOptions,
  network,
  ...
  const getBaseAssetSymbol = (symbol: string) => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div className="bg-bg-tertiary border border-color-border p-4 rounded-lg">
        <label className="block text-xs font-bold text-text-secondary uppercase tracking-widest mb-2">Amount</label>
        <input
          type="number"
          value={amount}
